...
{
    // if the pane has focus, set DrawCaption as blue.
    wxWindow *focus = wxWindow::FindFocus();
    wxWindow *paneWindow = pane.window;
...
wxAuiTabArt* wxMyTabArt::Clone()
{
    return new wxMyTabArt(*this);
}

void wxMyTabArt::SetFlags(unsigned int flags)
{
    m_flags = flags;
}

void wxMyTabArt::SetSizingInfo(const wxSize& tab_ctrl_size,
                                      size_t tab_count)
{
    m_fixedTabWidth = 100;
...
void wxMyTabArt::SetColour(const wxColour& colour)
{
...
void wxMyTabArt::SetActiveColour(const wxColour& colour)
{
    m_selectedBkBrush = wxBrush(colour);
    m_selectedBkPen = wxPen(colour);
}

void wxMyTabArt::DrawBorder(wxDC& dc, wxWindow* wnd, const wxRect& rect)
{
...
void wxMyTabArt::DrawBackground(wxDC& dc,
...
int wxMyTabArt::GetIndentSize()
{
    return 0;
}

int wxMyTabArt::GetBorderWidth(wxWindow* wnd)
{
...
int wxMyTabArt::GetAdditionalBorderSpace(wxWindow* WXUNUSED(wnd))
{
    return 0;
}

wxSize wxMyTabArt::GetTabSize(wxDC& dc,
                                     wxWindow* WXUNUSED(wnd),
...
void wxMyTabArt::DrawButton(wxDC& dc,
                                   wxWindow* WXUNUSED(wnd),
                                   const wxRect& in_rect,
                                   int bitmap_id,
                                   int button_state,
...
int wxMyTabArt::GetBestTabCtrlSize(wxWindow* wnd,
...
void wxMyTabArt::SetNormalFont(const wxFont& font)
{
    m_normalFont = font;
}

void wxMyTabArt::SetSelectedFont(const wxFont& font)
{
    m_selectedFont = font;
}

void wxMyTabArt::SetMeasuringFont(const wxFont& font)
{
