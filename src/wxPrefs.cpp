...
const LanguageInfo g_LanguagePrefs [] = {
    // C++
    {"C++",
        "*.c;*.cc;*.java;*.cpp;*.cxx;*.cs;*.h;*.hh;*.hpp;*.hxx;*.sma",
        wxSTC_LEX_CPP,
...
const StyleInfo g_StylePrefs [] = {
    ...
    // mySTC_TYPE_WORD2
    {wxT("Keyword2"),
     wxT("MIDNIGHT BLUE"), wxT("BLACK"),
     wxT(""), 10, 0, 0},

    // mySTC_TYPE_WORD3
    {wxT("Keyword3"),
     wxT("CORNFLOWER BLUE"), wxT("BLACK"),
     wxT(""), 10, 0, 0},
